const { Monitor } = require("andoi-util");
      ...
      guild
        ...
        .then((invites) => {
          ...
          if (invite.inviter) {
            ...
            if (im)
              global.onUpdateInvite(
                im,
                guild.id,
                Number(total + Number(bonus))
              );
          }
    ...
    this.client.on("guildMemberRemove", async (member) => {
      ...
      if (args[0] === "invites") {
        ...
        var embed = new MessageEmbed()
          .setDescription(
            `You have **${
              (data.total || 0) + (data.bonus || 0)
            }** invites! (**${data.regular || 0}** regular, **${
              data.bonus || 0
            }** bonus, **${data.leave || 0}** leaves, **${
              data.fake || 0
            }** fake)`
          )
          .setColor("RANDOM");
