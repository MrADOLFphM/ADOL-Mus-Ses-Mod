      ...
      .catch((err) => {
        ...
        mainMsg.edit(
          new Discord.MessageEmbed()
            ...
            .setColor("#FF0000")
            .setDescription(
              "You didn't mentioned a channel in time... So, I cancelled the giveaway!"
            )
        );
        return;
      });
      ...
      .catch((err) => {
        ...
        mainMsg.edit(
          new Discord.MessageEmbed()
            ...
            .setColor("#FF0000")
            .setDescription(
              "You didn't specified a prize in time... So, I cancelled the giveaway!"
            )
        );
        return;
      });
          ...
          if (reaction.emoji.name === "🎉") {
            const WinEmbed = new Discord.MessageEmbed()
              ...
              .setDescription(
                ...
                }> as you were the first one to react and you win __**${msg2}**__`
              );
